...
setwd ("./") ### Change the path to your main working directory. 


phenotype <- "HbA1C"
if(is.na(pmatch(phenotype, list.dirs("../")))){
  dir.create(paste0("../", phenotype))
}
outdir <- paste0("../", phenotype)
...
source ("v2.step2_load.libraries.R")

###
### Step 3 - Import input files
### 

source ("v2.step3_import.input.files.R")
...
source ("v2.step4_preprocessing.data.for.sparsity.R")

###
### Step 5 - Identify clusters of polar metabolites
###

source ("v2.step5_identify.WGCNA.clusters.for.metabolites.R")

###
### Step 6 - Link individual polar metabolites to phenotype of interest
###

source ("v2.step6_associate.metabolites.with.phenotype.R")
...
source ("v2.step7a_identify.WGCNA.clusters.for.lipids.R")

source ("v2.step7b_associate.lipids.with.phenotype.R")

###
### Step 8 - Link metabolite clusters to phenotype of interest
###

source ("v2.step8_associate.metabolite.clusters.with.phenotype.R")

###
### Step 9 - Link MGS metagenomic entities to phenotype of interest
###

source ("v2.step9_associate.MGSs.with.phenotype.R")

###
### Step 10 - Link KEGG functions to phenotype of interest
###

source ("v2.step10_associate.KEGG.modules.with.phenotype.R")
source ("v2.step10b_associate.humaan2.modules.with.phenotype.R")
###
### Step 11 - Save phenotype associations
###

source ("v2.step11_save.phenotype.associations.R")

###
### Step 12 - Select features with significant differences
###

source ("v2.step12_select.significant.features.R")
...
source ("v2.step13_associate.metabolite.clusters.with.KOs.R")
...
source ("v2.step14_associate.metabolite.clusters.with.KEGG.modules.R")

###
### Step 15 - Plot metabolome-microbiome functional analysis results
###

source ("v2.step15_plot.metabolome.microbiome.functional.analysis.R")
